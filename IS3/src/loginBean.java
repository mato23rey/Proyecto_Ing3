...
public class loginBean {
	...
	/**
	 * ID del usuario que se encuentra logueado, -1 para indicar que no hay nadie logueado. Sirve para renderizar correctamente la p�gina
	 */
	int userId = -1;
	...
	/**
	 * M�todo de acceso para realizar el login
	...
	/**Metodo que sirve para encontrar un usuario en base a su dirección de email
